...
#curl -X POST -d '{"jsonrpc": "2.0","method":"deploy", "params": {"type": 1,"chaincodeID":{"name":"SimpleSample"},"ctorMsg": {"args":["init", "a", "10", "b", "20"]}, "secureContext":"jim"},"id": 3}' http://127.0.0.1:7050/chaincode 
curl -X POST -d '{"jsonrpc": "2.0","method":"query", "params": {"type": 1,"chaincodeID":{"name":"SimpleSample"},"ctorMsg": {"args":["query", "a"]}, "secureContext":"jim"},"id": 5}' http://127.0.0.1:7050/chaincode 
